...
Route::group(['middleware'=>['auth']], function () {
    ...
    Route::group(['middleware'=>['admin']], function () {
        ...
        Route::post('/admin/remove-admin/{userId}', [AdminController::class, 'removeAdmin']);
        Route::post('/admin/give-admin/{userId}', [AdminController::class, 'giveAdmin']);

        Route::post('/admin/remove-lekarz/{userId}', [AdminController::class, 'removeLekarz']);
        Route::post('/admin/give-lekarz/{userId}', [AdminController::class, 'giveLekarz']);

        Route::post('/admin/remove-recepcja/{userId}', [AdminController::class, 'removeRecepcja']);
        Route::post('/admin/give-recepcja/{userId}', [AdminController::class, 'giveRecepcja']);
    });
});
Route::get('/', function () {
    return view('home');
